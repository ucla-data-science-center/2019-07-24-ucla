...
venue: "UCLA Library"        # brief name of host site without address (e.g., "Euphoric State University")
address: "280 Charles E. Young Drive, Los Angeles, CA"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
country: "us"      # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes)
language: "en"     # lowercase two-letter ISO language code such as "fr" (see https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes)
latlng: "34.075059,-118.441303"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
...
instructor: ["Leigh Phan", "Jamie Jamison", "Kristian Allen"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Dave George", "Scott Gruber", "Tim Dennis", "Jen Diamond", "David Palmquist"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["datascience@ucla.edu", "leighphan@ucla.edu", "jamison@library.ucla.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes: https://pad.carpentries.org/2019-ucla-lc             # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
...
<h2 id="register"> <a href="https://calendar.library.ucla.edu/event/5526595"> Register Now! </a> </h2>
...
<p>
  <strong>Parking Information:</strong> Nearest automobile parking to the workshop location is Parking Structure 2. <a href="https://map.ucla.edu/?k=true&id=194">View Parking Structure 2 and get directions through our campus map</a>.
{% endif %}
